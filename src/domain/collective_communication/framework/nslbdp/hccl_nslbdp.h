...
public:
    ...
    HcclResult SendTableProc(u32 packetNum, NslbDpCommConfigVal cominfo);
    ...
    HcclResult SendGlobalRankTable();
    HcclResult SendTableGlobalRankProc(uint32_t packetNum, NslbDpGlobalRankVal &cominfo);

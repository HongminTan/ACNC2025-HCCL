...
enum TemplateType {
    ...
    TEMPLATE_BROADCAST_HALVLINGDOUBLING = 9,                  // BcastHalvingDoubling
    ...
    TEMPLATE_ALL_2_ALL_V_MESH_READ_ONLY = 14,             // AlltoAllVMeshReadOnly
    ...
    TEMPLATE_ALL_GATHER_SIO_HCCS = 88,

...
{
    HCCL_INFO("[AllGatherAHCBroke][RunInterAllGather] begin inter all gather rank[%u]", rank);
    ...
    HCCL_DEBUG("[AllGatherAHCBroke][RunInterAllGather] end inter all gather rank[%u]", rank);

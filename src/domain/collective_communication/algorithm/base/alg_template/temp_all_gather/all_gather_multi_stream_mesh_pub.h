...
#ifndef ALL_GATHER_MULTI_STREAM_MESH_PUB_H
#define ALL_GATHER_MULTI_STREAM_MESH_PUB_H

#include "alg_template_base_pub.h"

namespace hccl {
class AllGatherMultiStreamMesh : public AlgTemplateBase {
public:
    explicit AllGatherMultiStreamMesh(const HcclDispatcher dispatcher); // 所有大环的rank个数，commcombine提供接口

    ~AllGatherMultiStreamMesh() override;

    // should be called soon after template AllGatherNew instance created
...
#endif /* ALL_GATHER_MULTI_STREAM_MESH_PUB_H */

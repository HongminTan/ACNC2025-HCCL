...
{
    // 获取当前rank的组间rank
    HCCL_INFO("[ReduceScatterAHC][RunInterReduceScatter] begin inter reduce scatter rank[%u]", rank);
    ...
    HCCL_DEBUG("[ReduceScatterAHC][RunInterReduceScatter] end inter reduce scatter rank[%u]", rank);

...
{
    // 获取当前rank的组间rank
    HCCL_INFO("[ReduceScatterAHCBroke][RunInterReduceScatter] begin inter reduce scatter rank[%u]", rank);
    ...
    HCCL_DEBUG("[ReduceScatterAHCBroke][RunInterReduceScatter] end inter reduce scatter rank[%u]", rank);
